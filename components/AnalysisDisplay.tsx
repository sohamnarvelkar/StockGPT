...
import { Download, FileText, Share2, Printer, Check, Copy, TrendingUp, Anchor, Activity, Globe, PieChart as PieChartIcon, BarChart3, LineChart as LineChartIcon, Bookmark, Bell, ArrowRightCircle, Scale } from 'lucide-react';
      ...
      <div id="analysis-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
            ...
            <div className="glass-panel p-4 rounded-xl">
                ...
                <p className="text-slate-200 leading-normal text-base">
                {data.summary}
                </p>
            </div>
            ...
            {macroSection && (
                <div className="rounded-xl border border-dashed border-indigo-500/40 bg-slate-900/60 p-4 relative overflow-hidden">
